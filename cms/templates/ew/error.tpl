	...
	<main class="container-fluid px-0">
		<aside class="px-xl-5 px-4 auth-aside" data-bs-theme="none">
			<div class="row">
                ...
                <div class="col-12">
                    <img class="img-responsive" src="{$stheme}/images/404.png" alt="">
                </div>
            </div>
		</aside>
			...
			<form>
				<ul class="row g-3 list-unstyled li_animate">
					...
					<li class="col-12 mt-4">
						<span class="display-5 fw-bold">OOPS!</span> <span class="display-1 fw-bold">4<i class="fa fa-smile-o"></i>4</span>
						<h5>{$error_message}</h5>
					</li>
					<li class="col-12 mt-4">
					...
					<li class="col-12 mt-4">
						<h4 class="fw-light mb-0">Потерялось что-то очень важное?</h4>
						<p>Мы можем помочь вам найти потерянные данные!</p>
						<div class="tagcloud mb-4">
							<a href="#" class="tag-link rounded-pill border px-3" style="--hover-color: var(--theme-color1)">Тех. поддержка</a>
						</div>
					</li>
				</ul>
			</form>
