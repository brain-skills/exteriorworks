	...
	<main class="container-fluid px-0">
		...
		<aside class="px-xl-5 px-4 auth-aside" data-bs-theme="none">
            <div class="row">
                ...
                <div class="col-12">
                    <img class="img-responsive" src="{$stheme}/images/sign-in.png" alt="">
                </div>
            </div>
		</aside>
		...
		<div class="px-xl-5 px-4 auth-body">
			<form method="POST" action="engine/login.php">
				<ul class="row g-3 list-unstyled li_animate">
					...
					<li class="col-12">
						<h1 class="h2 title-font">Вход в Панель управления</h1>
						<p class="mb-0">-</p>
					</li>
					<li class="col-12">
					...
					<li class="col-12">
						<div class="form-label">
							<span class="d-flex justify-content-between align-items-center">
								Password
								<a class="text-primary" href="password-reset.html">Забилы пароль?</a>
							</span>
						</div>
					...
					<li class="col-12">
						<div class="form-check fs-5">
							...
							<label class="form-check-label fs-6" for="Rememberme">Запомнить это устройство</label>
						</div>
					</li>
					<li class="col-12">
						<button type="submit" class="btn btn-lg w-100 btn-primary text-uppercase mb-2">Войти</button>
					</li>
					<li class="col-12">
						<span class="text-muted d-flex d-sm-inline-flex">Ещё нет аккаунта? <a class="ms-2" href="#" title="">Зарегистрироваться</a></span>
					</li>
				</ul><!--[ ul.row end ]-->
			</form>
		</div>
