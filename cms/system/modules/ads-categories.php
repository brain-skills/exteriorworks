<?php
    ...
    */
    ...
    $sql = "SELECT * FROM ads_categories";
    ...
    $yourData = array('title' => $lang['nav']['adscategorieslist'] . ' - Skills Energy');
    $smarty->assign('data', $yourData);
    $smarty->assign('page_name', '
        <li class="breadcrumb-item active"><a href="/admin?action=ads">Объявления</a></li>
        <li class="breadcrumb-item active">' . $lang['nav']['adscategorieslist'] . '</li>
    ');
