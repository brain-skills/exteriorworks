<?php
    ...
    */
    ...
    $sql = "SELECT * FROM files_categories";
    ...
    $yourData = array('title' => $lang['nav']['filescategorieslist'] . ' - Skills Energy');
    $smarty->assign('data', $yourData);
    $smarty->assign('page_name', '
        <li class="breadcrumb-item active"><a href="/admin?action=files">Файлы</a></li>
        <li class="breadcrumb-item active">' . $lang['nav']['filescategorieslist'] . '</li>
    ');
