						...
						<div class="row">
							<div class="col-6">
								...
								<div class="input-group">
									<input type="text" name="title" class="form-control mt-2 mb-2" placeholder="Заголовок новости">
								...
								<fieldset class="form-icon-group left-icon position-relative">
									<input type="text" class="form-control mt-2 mb-2" name="alt_name" id="alt_name" placeholder="URL новости">
									<div class="form-icon position-absolute">
