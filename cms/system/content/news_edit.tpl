{block name="content"}
<form method="post" action="/admin?action=news_edit" enctype="multipart/form-data">
	<div class="row">
		<div class="col-12">
					...
					<div class="row">
						<div class="col-6">
							...
							<div class="input-group">
								<input type="text" name="title" class="form-control mt-2 mb-2" placeholder="Заголовок новости" value="{$page.title}">
								<div class="input-group-prepend">
								  <span class="input-group-text mt-2 mb-2" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Заголовок новости. Допустимо использование символов и пробелов">?</span>
								</div>
							</div>
							<fieldset class="form-icon-group left-icon position-relative">
								<input type="text" class="form-control mt-2 mb-2" name="alt_name" id="alt_name" placeholder="URL новости" value="{$page.alt_name}">
								<div class="form-icon position-absolute">
		...
		<div class="col-3">
			<button type="submit" name="addnew" class="btn btn-success mt-2 mb-2">Добавить</button>
		</div>
		<input type="hidden" name="folder" id="folder" value="news">
...
<script>
	...
	var currentLink = document.getElementById('addNews');
