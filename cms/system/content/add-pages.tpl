<div class="col-12">
	<form method="POST" enctype="multipart/form-data">
		<div class="row">
						...
						<div class="row">
							...
							<div class="col-5">
								<div class="input-group">
									<input type="text" name="title" class="form-control mt-2 mb-2" placeholder="Заголовок страницы">
			...
			<div class="col-3">
				<button type="submit" name="addpage" class="btn btn-success mt-2 mb-2">Добавить</button>
			</div>
